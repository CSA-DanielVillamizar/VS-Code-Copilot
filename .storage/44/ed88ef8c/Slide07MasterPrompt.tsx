...
- Documentación básica`;
  ...
  const handleCopy = async () => {
    try {
      await navigator.clipboard.writeText(masterPromptTemplate);
      setCopied(true);
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="flex flex-col space-y-4">
            <div className="bg-slate-800/50 backdrop-blur-sm p-4 rounded-2xl border border-slate-700">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-xl font-bold text-white">¿Qué es un Prompt Maestro?</h2>
              </div>
            ...
            <div className="bg-violet-500/10 border border-violet-500/30 rounded-xl p-4">
              ...
              <div className="space-y-2">
                {[
                  { num: "1", title: "ROL", desc: "Define qué tipo de experto necesitas" },
                  { num: "2", title: "OBJETIVO", desc: "Describe claramente qué quieres crear" },
                  { num: "3", title: "Q&A", desc: "Pide preguntas antes de empezar" },
                  ...
                  { num: "7", title: "RESTRICCIONES", desc: "Limita tecnología, complejidad" },
                  { num: "8", title: "ENTREGABLES", desc: "Lista qué necesitas al final" }
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-2 bg-slate-900/30 p-2 rounded-lg">
                    <div className="bg-violet-500 text-white w-5 h-5 rounded flex items-center justify-center flex-shrink-0 text-xs font-bold">
                      {item.num}
                    </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-base font-semibold text-blue-300">Flujo de Trabajo</h3>
              </div>
              <div className="space-y-2 text-xs text-slate-300">
                <div className="flex items-start gap-2">
                  <span className="text-blue-400 font-bold">1.</span>
                  <p><strong>Construye:</strong> Usa ChatGPT/Claude/Gemini</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-400 font-bold">2.</span>
                  <p><strong>Guarda:</strong> Almacena en Notion o Markdown</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-400 font-bold">3.</span>
                  <p><strong>Ejecuta:</strong> Pega en modelo razonador</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-400 font-bold">4.</span>
                  <p><strong>Implementa:</strong> Lleva a VS Code + Copilot</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-3 text-center">
              <p className="text-sm text-green-200 font-medium">
                💡 Este template es reutilizable para todos tus proyectos
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold text-white">Template del Prompt Maestro</h3>
              <button
                onClick={handleCopy}
            ...
            <div className="mt-3 space-y-2">
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3">
                <p className="text-xs text-orange-200">
                  <strong>📝 Tip:</strong> Muestra un ejemplo real completado. Explica cómo cada sección guía a la IA hacia mejores resultados.
                </p>
              </div>
              
              <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-3">
                <p className="text-xs text-violet-200">
                  <strong>🎯 Resultado:</strong> Con este prompt, la IA generará una especificación de 2-3 páginas que puedes usar directamente en VS Code.
                </p>
              </div>
            </div>
          </div>
