...
import { Download, ExternalLink, Users, CheckSquare, Mail, MessageCircle, Linkedin, Phone } from "lucide-react";
...
const Slide09Activity: React.FC = () => {
  ...
  const handleDownloadTemplate = () => {
    ...
    link.href = '/PROMPT_MAESTRO_TEMPLATE.md';
    link.download = 'PROMPT_MAESTRO_TEMPLATE.md';
  ...
  const handleViewExample = () => {
    window.open('https://docs.mgx.dev', '_blank');
  };

  const handleJoinGroup = () => {
    window.open('https://discord.gg/metagpt', '_blank');
  };
  ...
  const steps = [
    {
      ...
      tip: "Empieza con algo que uses diariamente. Será más fácil definir las funcionalidades."
    },
    {
      number: 2,
      ...
      tip: "Guarda el template en un archivo para reutilizarlo en futuros proyectos."
    },
    {
      number: 3,
      ...
      tip: "Sé específico en el objetivo. En lugar de 'app de tareas', di 'app para gestionar tareas diarias con recordatorios'."
    },
    {
      number: 4,
      ...
      tip: "No tengas miedo de pedir cambios en la especificación si algo no te convence."
    },
    {
      number: 5,
      title: "Lleva el Plan a VS Code",
      description: "Abre VS Code, crea una carpeta nueva para tu proyecto, crea los archivos mencionados en el plan",
      tip: "Organiza tus archivos desde el inicio. Crea carpetas para CSS, JS e imágenes si es necesario."
    },
    {
      number: 6,
      title: "Genera el Código con Copilot",
      description: "En cada archivo, escribe comentarios guía detallados describiendo qué debe hacer cada sección",
      tip: "Los comentarios son clave. Escribe '// Función para agregar tarea que valide campos vacíos'."
    },
    {
      number: 7,
      title: "Prueba tu App",
      description: "Abre index.html en tu navegador, prueba todas las funcionalidades",
      tip: "Prueba casos extremos: ¿qué pasa si dejas campos vacíos? ¿Si agregas 100 items?"
    },
    {
      number: 8,
      title: "¡Celebra y Comparte! 🎉",
      description: "Acabas de crear tu primera aplicación con IA. Comparte tu logro en redes sociales",
      tip: "Guarda tu proyecto en GitHub. Es tu portafolio y puedes mostrarlo en entrevistas."
    }
  ];
      ...
      <div ref={contentRef} className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-6">
              ...
              {steps.map((step) => (
                ...
                >
                  <div className="flex items-start gap-2 mb-2">
                    <div className="bg-blue-500 text-white w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 font-bold text-sm">
                      {step.number}
                    </div>
          ...
          <div className="flex flex-col gap-3 overflow-y-auto">
            <div className="bg-slate-800/50 backdrop-blur-sm p-4 rounded-2xl border border-slate-700">
              ...
              <div className="space-y-2">
                <button 
                  ...
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 font-medium text-xs"
                >
                ...
                <button 
                  ...
                  className="w-full bg-violet-500 hover:bg-violet-600 text-white px-3 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 font-medium text-xs"
                >
                ...
                <button 
                  ...
                  className="w-full bg-green-500 hover:bg-green-600 text-white px-3 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 font-medium text-xs"
                >
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm p-4 rounded-2xl border border-slate-700">
              ...
              <div className="space-y-2">
                {checklist.map((item, i) => (
                  <div key={i} className="flex items-center gap-2 bg-slate-900/50 p-2 rounded-lg">
                    <div className="w-4 h-4 border-2 border-slate-600 rounded flex-shrink-0"></div>
            ...
            <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/50 rounded-xl p-3 text-center">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-3">
              ...
              <div className="space-y-2 text-xs text-slate-300">
                ...
                <div className="mt-2 pt-2 border-t border-slate-700 space-y-1">
                  <a 
                    href="https://www.linkedin.com/in/danielvillamizara/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-xs text-blue-400 hover:text-blue-300 transition-colors"
                  >
                    <Linkedin className="w-3 h-3" />
                    linkedin.com/in/danielvillamizara
                  </a>
                  <a 
